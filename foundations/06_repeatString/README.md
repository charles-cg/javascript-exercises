...
This function will take two arguments, `string` and `num`. If `num` is a
negative number, return the string `'ERROR'` instead.
...
- How can you iteratively build up the final string, using one of the inputs to
